      ...
      <div className="projects">
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Oopsie</h3>
              <p>
                The Forgetters Getter
                <a href="https://www.fcamara.com.br/"> Oopsie</a>.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
                A landing page of a fictional company proposed by{" "}
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  // TODO: Make all of these one single component
                  href="https://github.com/dthomason/"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="body">
              <h3>Another box</h3>
              <p>Another box to put some stuff in</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Dtmoney</h3>
              <p>A BitCoin app that does some stuff</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>VueJs</li>
